...
signal herbalist_contract_started(id: StringName, end_time: float, bees: int)
signal herbalist_contract_completed(id: StringName, success: bool)
signal herbalist_bees_available_changed(count: int)
